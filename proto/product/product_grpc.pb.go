...
const (
	...
	ProductService_ReduceProductQty_FullMethodName = "/proto.ProductService/ReduceProductQty"
)
...
type ProductServiceClient interface {
	...
	ReduceProductQty(ctx context.Context, in *ReduceProductRequest, opts ...grpc.CallOption) (*ReduceProductResponse, error)
}
...
func (c *productServiceClient) ReduceProductQty(ctx context.Context, in *ReduceProductRequest, opts ...grpc.CallOption) (*ReduceProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReduceProductResponse)
	err := c.cc.Invoke(ctx, ProductService_ReduceProductQty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	ReduceProductQty(context.Context, *ReduceProductRequest) (*ReduceProductResponse, error)
...
func (UnimplementedProductServiceServer) ReduceProductQty(context.Context, *ReduceProductRequest) (*ReduceProductResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReduceProductQty not implemented")
}
...
func _ProductService_ReduceProductQty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReduceProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).ReduceProductQty(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_ReduceProductQty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).ReduceProductQty(ctx, req.(*ReduceProductRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReduceProductQty",
			Handler:    _ProductService_ReduceProductQty_Handler,
		},
	},
